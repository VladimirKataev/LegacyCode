...
public class GameCharacter extends GameObject{
	...
	public void setMovable(boolean u){canMove = u;}
	...
	public void unMove(UserAction input, Matrix cam){
		if(input.getUp()){
			points.add(1,0,-1);
			points.add(1,1,-1);
			points.add(1,2,-1);
	...
	public void draw(Graphics bb, Matrix camTrans){
		...
		bb.drawOval((int)rendPoints.get(0,0),(int) rendPoints.get(1,0),(int) (50* camTrans.get(0,0)),(int) (camTrans.get(1,1)* 50));
		//bb.drawLine((int)rendPoints.get(0,0), (int) rendPoints.get(1,0),(int) rendPoints.get(0,3),(int) rendPoints.get(1,3) );
	}
	public boolean checkCollision(int oX, int oY, int oWidth, int oHeight){return false;}
